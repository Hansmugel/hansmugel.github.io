...
document.getElementById('proceedBtn').addEventListener('click', function() {
    ...
    // Convert the number to a string and extract the first 10 characters
    const formattedRandomNumber = randomNumber.toString().substring(0, 10);

    // Display the formatted random number on the site
    document.getElementById('randomNumber').textContent = formattedRandomNumber;
